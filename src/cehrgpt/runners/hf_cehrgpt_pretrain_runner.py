...
def load_and_create_model(
    ...
    try:
        ...
        model_config = CEHRGPTConfig(
            ...
            clinical_token_ids=tokenizer.clinical_token_ids,
            att_token_ids=tokenizer.att_token_ids,
            motor_time_to_event_weight=cehrgpt_args.motor_time_to_event_weight,
            motor_tte_vocab_size=len(tokenizer.clinical_token_ids),
            motor_num_time_pieces=len(tokenizer.att_token_ids),
...
def main():
    ...
    trainer = trainer_class(
        ...
        data_collator=data_collator_fn(
            ...
            include_motor_time_to_event=cehrgpt_args.include_motor_time_to_event,
            motor_tte_vocab_size=len(cehrgpt_tokenizer.clinical_token_ids),
            motor_num_time_pieces=len(cehrgpt_tokenizer.att_token_ids),
