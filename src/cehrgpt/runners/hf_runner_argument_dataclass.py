...
class ModelArguments:
    ...
    use_knowledge_graph: Optional[bool] = dataclasses.field(
        default=False,
        metadata={"help": "Whether or not to use a knowledge graph to build model."},
    )

    num_graph_hidden_layers: Optional[int] = dataclasses.field(
        default=3,
        metadata={"help": "The number of layers used in the graph network. Defines a node's field of influence."},
    )

    knowledge_graph_path: Optional[str] = dataclasses.field(
        default=None,
        metadata={"help": "The path to a knowledge graph containing pickle file."}
    )
