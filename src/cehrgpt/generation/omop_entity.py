...
class VisitOccurrence(OmopEntity):
    ...
    def export_as_json(self):
        return {
            ...
            "visit_start_date": str(self._visit_start_date),
            "visit_start_datetime": self._visit_start_datetime,
            "visit_end_date": str(self._visit_end_date),
...
class ConditionOccurrence(OmopEntity):
    ...
    def export_as_json(self):
        return {
            ...
            "condition_start_date": str(self._condition_start_date),
            "condition_start_datetime": self._condition_start_datetime,
            "condition_end_date": str(self._condition_end_date),
...
class DrugExposure(OmopEntity):
    ...
    def export_as_json(self):
        return {
            ...
            "drug_exposure_start_date": str(self._drug_exposure_start_date),
            "drug_exposure_start_datetime": self._drug_exposure_start_datetime,
            "drug_exposure_end_date": str(self._drug_exposure_end_date),
            "drug_exposure_end_datetime": self._drug_exposure_end_datetime,
            "verbatim_end_date": str(self._drug_exposure_end_date),
...
class ProcedureOccurrence(OmopEntity):
    ...
    def export_as_json(self):
        return {
            ...
            "procedure_date": str(self._procedure_date),
...
class Death(OmopEntity):
    ...
    def export_as_json(self):
        return {
            "person_id": self._person._person_id,
            "death_date": str(self._death_date),
...
class Measurement(OmopEntity):
    ...
    def export_as_json(self):
        return {
            ...
            "measurement_date": str(self._measurement_date),
